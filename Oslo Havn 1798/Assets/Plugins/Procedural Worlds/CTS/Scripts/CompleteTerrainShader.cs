...
#region old string based lookup
        ...
        public void UpdateShader()
        {
            ...
            if (m_profile.m_useMaterialControlBlock)
            {
                ...
                if (m_cutoutMask != null)
                {
                    m_materialPropertyBlock.SetTexture(CTSShaderID.Texture_Additional_Masks, m_cutoutMask);
                }
            ...
            else
            {
                ...
                if (m_cutoutMask != null)
                {
                    m_material.SetTexture(CTSShaderID.Texture_Additional_Masks, m_cutoutMask);
                }
