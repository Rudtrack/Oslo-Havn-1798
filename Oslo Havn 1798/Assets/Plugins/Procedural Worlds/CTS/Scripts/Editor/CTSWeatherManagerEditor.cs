...
namespace CTS
{
    ...
    public class CTSWeatherManagerEditor : Editor
    {
        ...
        private bool seasonalTintActive = true;
        ...
        public override void OnInspectorGUI()
        {
            ...
            seasonalTintActive = EditorGUILayout.Toggle(GetLabel("Seasonal Tint"), m_manager.SeasonalTintActive);
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                m_manager.SeasonalTintActive = seasonalTintActive;
