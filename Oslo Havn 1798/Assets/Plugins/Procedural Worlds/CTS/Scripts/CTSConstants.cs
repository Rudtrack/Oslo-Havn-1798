...
namespace CTS
{
    ...
    public static class CTSConstants
    {
        ...
        public static readonly Dictionary<CTSShaderCriteria, string> shaderNames = new Dictionary<CTSShaderCriteria, string>()
        {
            ...
            { new CTSShaderCriteria(EnvironmentRenderer.LightWeight2018x, ShaderType.Basic, ShaderFeatureSet.None), "CTS/LWRP/CTS Terrain Shader Basic" },
            { new CTSShaderCriteria(EnvironmentRenderer.LightWeight2018x, ShaderType.Basic, ShaderFeatureSet.Cutout),"CTS/LWRP/CTS Terrain Shader Basic CutOut" },
            { new CTSShaderCriteria(EnvironmentRenderer.LightWeight2018x, ShaderType.Advanced, ShaderFeatureSet.None), "CTS/LWRP/CTS Terrain Shader Advanced" },
            { new CTSShaderCriteria(EnvironmentRenderer.LightWeight2018x, ShaderType.Advanced, ShaderFeatureSet.Cutout), "CTS/LWRP/CTS Terrain Shader Advanced CutOut" },
            { new CTSShaderCriteria(EnvironmentRenderer.LightWeight2018x, ShaderType.Lite, ShaderFeatureSet.None), "CTS/LWRP/CTS Terrain Shader Lite" },
            { new CTSShaderCriteria(EnvironmentRenderer.HighDefinition2018x, ShaderType.Basic, ShaderFeatureSet.None), "CTS/HDRP/CTS Terrain Shader Basic" },
            { new CTSShaderCriteria(EnvironmentRenderer.HighDefinition2018x, ShaderType.Basic, ShaderFeatureSet.Cutout),"CTS/HDRP/CTS Terrain Shader Basic CutOut" },
            { new CTSShaderCriteria(EnvironmentRenderer.HighDefinition2018x, ShaderType.Advanced, ShaderFeatureSet.None), "CTS/HDRP/CTS Terrain Shader Advanced" },
            { new CTSShaderCriteria(EnvironmentRenderer.HighDefinition2018x, ShaderType.Advanced, ShaderFeatureSet.Cutout), "CTS/HDRP/CTS Terrain Shader Advanced CutOut" },
            { new CTSShaderCriteria(EnvironmentRenderer.HighDefinition2018x, ShaderType.Lite, ShaderFeatureSet.None), "CTS/HDRP/CTS Terrain Shader Lite" }
        };
