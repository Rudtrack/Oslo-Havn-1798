...
namespace PWCommon1
{
    ...
    public partial class EditorUtils
    {
        ...
        public void MinMaxSliderWithFields(string key, ref float minValue, ref float maxValue, float minLimit, float maxLimit)
        {
            ...
            minValue = EditorGUI.FloatField(new Rect(rect.x, rect.y, EditorGUIUtility.fieldWidth, rect.height), minValue);
            EditorGUI.MinMaxSlider(new Rect(rect.x + EditorGUIUtility.fieldWidth + 5f, rect.y, rect.width - 10f - 2 * EditorGUIUtility.fieldWidth, rect.height), ref minValue, ref maxValue, minLimit, maxLimit);
            maxValue = EditorGUI.FloatField(new Rect(rect.xMax - EditorGUIUtility.fieldWidth, rect.y, EditorGUIUtility.fieldWidth, rect.height), maxValue);
